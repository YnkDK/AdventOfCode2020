...
from dec04 import solve, Passport, parse_input


class December04Test(unittest.TestCase):
    __RAW_EXAMPLE = """ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
byr:1937 iyr:2017 cid:147 hgt:183cm
...
iyr:2011 ecl:brn hgt:59in"""
    ...
    __REQUIRED_FIELDS = frozenset({'byr', 'iyr', 'eyr', 'hgt', 'hcl', 'ecl', 'pid'})

    def test(self):
        passports = parse_input(December04Test.__RAW_EXAMPLE)
        self.assertEqual(4, len(passports))
        result = solve(passports)
    ...
    def test_year(self):
        ...
        self.assertTrue(passport.is_year_valid('byr', 1920, 2002))
        passport = Passport('byr:2003')
        self.assertFalse(passport.is_year_valid('byr', 1920, 2002))
    ...
    def test_height(self):
        ...
        self.assertTrue(passport.is_height_valid())
        passport = Passport('hgt:190cm')
        self.assertTrue(passport.is_height_valid())
        passport = Passport('hgt:190in')
        self.assertFalse(passport.is_height_valid())
    ...
    def test_hair_color(self):
        ...
        self.assertTrue(passport.is_hair_color_valid())
        passport = Passport('hcl:#123abz')
        self.assertFalse(passport.is_hair_color_valid())
        passport = Passport('hcl:123abc')
        self.assertFalse(passport.is_hair_color_valid())
    ...
    def test_eye_color(self):
        ...
        self.assertTrue(passport.is_eye_color_valid())
        passport = Passport('ecl:wat')
        self.assertFalse(passport.is_eye_color_valid())
    ...
    def test_pid(self):
        ...
        self.assertTrue(passport.is_pid_valid())
        passport = Passport('pid:0123456789')
        self.assertFalse(passport.is_pid_valid())
...
eyr:2038 hcl:74454a iyr:2023
pid:3556412378 byr:2007"""
        passports = parse_input(invalids)
        self.assertEqual(0, solve(passports))
...
iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719"""
        passports = parse_input(valid)
        self.assertEqual(4, solve(passports))
