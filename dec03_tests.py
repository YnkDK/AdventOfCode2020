...
from dec03 import solve, Grid


class December03Test(unittest.TestCase):
    _example = Grid("""..##.......
#...#...#..
.#....#..#.
..#.#...#.#
...
.#..#...#.#""".splitlines())
    ...
    def test_part_1(self):
        self.assertEqual(solve(self._example, [(3, 1)]), 7)

    def test_part_2(self):
        self.assertEqual(solve(self._example, [(1, 1), (3, 1), (5, 1), (7, 1), (1, 2)]), 336)
