...
from dec01 import solve


class December01Test(unittest.TestCase):
    _example = (1721, 979, 366, 299, 675, 1456)

    def test_with_two_entries(self):
        self.assertEqual(solve(self._example, 2), 514579)

    def test_with_three_entries(self):
        self.assertEqual(solve(self._example, 3), 241861950)
